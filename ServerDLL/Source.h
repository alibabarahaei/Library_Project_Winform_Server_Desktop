...
typedef void(*UIMessage)(std::string user, std::string message);
typedef void(*UIDownload)(std::string Name, std::string Extention);
...
extern "C" UI_ALPI void  Startup(string ip, int port, UIChangeProgress  uiChangeprogress, UINewClient uiNewclient, UINewRecieve  uiNewrecieve, UIMessage uimessage);
